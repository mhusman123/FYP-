...
export default function PrimaryEducationPage() {
  ...
  const primaryStages = [
    {
      keyStage: 'Key Stage 1 (Years 1 & 2)',
      age: 'Ages 5 – 7',
      badge: 'Active Literacy & Numeracy',
      desc: 'Focusing on building foundational reading confidence through synthetic phonics in English, Urdu, and Sindhi, hands-on mathematical operations, early scientific experiments, and creative art expression.'
    },
    {
      keyStage: 'Key Stage 2 (Years 3 to 6)',
      age: 'Ages 7 – 11',
      badge: 'Critical Inquiry & Global Horizons',
      desc: 'Developing deeper scientific investigation, advanced mathematical problem-solving, computing & robotics, historical and environmental projects in Sindh, and introducing French or Arabic as a second foreign language in Year 5.'
    }
  ]

  const subjects = [
    { name: 'Cambridge Primary English', icon: BookOpen, desc: 'Grammar, creative writing, drama, and critical comprehension.' },
    { name: 'Cambridge Primary Mathematics', icon: Sparkles, desc: 'Conceptual numeracy, geometry, data handling, and mental agility.' },
    { name: 'Cambridge Primary Science', icon: FlaskConical, desc: 'Scientific inquiry, biology, chemistry, and physics experiments in labs.' },
    { name: 'Computing & Digital Tech', icon: Laptop, desc: '1:1 iPad learning, Scratch block coding, robotics, and cyber safety.' },
    { name: 'Urdu & Sindhi Literature', icon: Languages, desc: 'Mastering prose, regional poetry, Bait-bazi, and cultural heritage.' },
    { name: 'Second Foreign Language', icon: Globe, desc: 'French or Arabic language study starting in Year 5 and Year 6.' },
    { name: 'Physical Education & Swimming', icon: Activity, desc: 'Cricket, football, track athletics, and weekly heated pool swimming.' },
    { name: 'Creative Arts & Music', icon: Award, desc: 'Visual arts, classical instruments (harmonium/sitar/piano), and choirs.' }
  ]

  const faqs = [
    {
      q: 'What curriculum is followed in Primary School?',
      a: 'We follow the world-renowned Cambridge Primary curriculum integrated with the Sindh Provincial Board framework for local languages, Pakistan Studies, and Islamic Studies.'
    },
    {
      q: 'How is digital technology used in primary classrooms?',
      a: 'Every student uses managed 1:1 iPads for interactive quizzes, digital storytelling, coding exercises, and automated AI diagnostic feedback that complements traditional handwriting.'
    },
    {
      q: 'When do students start learning a foreign language beyond Urdu and Sindhi?',
      a: 'In addition to continuous English, Urdu, and Sindhi studies, students choose French or Arabic as a second foreign language starting in Year 5 (Grade 4 equivalent).'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <section className="relative overflow-hidden bg-[#002E40] text-white py-16 sm:py-24 lg:py-28">
        <HeroVideoBackground
          imageUrl="https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=85&w=2400&auto=format&fit=crop"
          posterUrl="https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=85&w=2400&auto=format&fit=crop"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.12]">
                Primary Education: <span className="text-cyan-300">Ages 5 – 11</span>
                <span className="block text-2xl sm:text-3xl font-semibold text-slate-300 mt-2">
                  پرائمري تعليم: مضبوط بنياد، سائنس ۽ خود اعتمادي (عمر 5 کان 11 سال)
                </span>
              </h1>

              <p className="text-base sm:text-lg text-slate-200 leading-relaxed max-w-2xl font-normal">
                Igniting intellectual curiosity in Key Stages 1 & 2. Developing strong foundations in Mathematics, Sciences, Trilingual Literacy (English, Urdu, Sindhi), Computational Thinking (Scratch/Block Coding), and collaborative team sports.
              </p>
              ...
              <div className="grid grid-cols-4 gap-3 pt-6 border-t border-white/15">
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">5 – 11</div>
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-300 font-medium">Interactive Screens</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">1:1</div>
                  <div className="text-[11px] text-slate-300 font-medium">Tablet Program</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-cyan-300 tracking-tight">10+</div>
                  <div className="text-[11px] text-slate-300 font-medium">Primary Subjects</div>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-2xl p-6 sm:p-8 bg-[#001724]/60 backdrop-blur-xl border border-cyan-500/30 shadow-2xl space-y-5">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-cyan-300">Live Primary Classroom Stream</span>
                  </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-lg font-bold text-white tracking-tight">
                    Hands-On Science Experiments & Scratch Robotics
                  </h3>
                  <p className="text-xs text-slate-300 leading-relaxed font-light">
                    Watch primary pupils engage in collaborative mathematics challenges, digital storytelling, and trilingual speech contests.
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-cyan-300 font-semibold">Junior Robotics</div>
                    <div className="text-lg font-black text-white">Micro:bit & LEGO</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-emerald-300 font-semibold">Reading Guild</div>
                    <div className="text-lg font-black text-white">1,000+ Books</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              Structured to transition children smoothly from foundational phonics and play into independent, inquisitive critical thinkers.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {primaryStages.map((stg, idx) => (
              <div key={idx} className="bg-slate-50 rounded-3xl p-8 border border-slate-200 shadow-sm space-y-4">
                ...
                <div className="pt-2 border-t border-slate-200 flex items-center gap-2 text-xs font-semibold text-emerald-700">
                  ...
                  <span>Individualized diagnostic feedback</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 sm:py-20 bg-slate-100 border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              A comprehensive subject matrix delivered by subject-specialist teachers in purpose-built facilities.
            </p>
          </div>
            ...
            {subjects.map((sub, idx) => {
              ...
              return (
                <div key={idx} className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-3">
                  ...
                  <h3 className="text-base font-bold text-[#002E40]">{sub.name}</h3>
          ...
          <div className="bg-[#002E40] text-white rounded-3xl p-8 sm:p-10 shadow-xl flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="space-y-2 text-slate-200">
              ...
              <p className="text-sm sm:text-base font-medium italic leading-relaxed text-white">
                "Primary education is where children discover how the universe works — connecting coding logic with the poetry of Sindh, and mathematics with the beauty of scientific exploration."
              </p>
              <div>
      ...
      <section className="bg-gradient-to-r from-[#002E40] to-[#8D1B2D] text-white py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-5">
          <h2 className="text-2xl sm:text-3xl font-black">
            Enrol Your Child in Our Primary School
          </h2>
          <p className="text-xs sm:text-sm text-slate-200 max-w-xl mx-auto">
            Book an assessment and tour our primary science labs, library, and sports facilities in Karachi or Hyderabad.
          </p>
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Button size="lg" className="bg-white text-[#002E40] hover:bg-slate-100 font-bold px-7 shadow-lg" asChild>
              <Link href="/home#enquiry-form">Schedule Primary Tour</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-slate-300 bg-white text-slate-800 hover:bg-slate-100 hover:text-slate-900 font-semibold shadow-xs" asChild>
              <Link href="/our-school/secondary-education">Explore Secondary Education</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-xs">
          <div className="flex flex-col sm:flex-row items-center justify-between border-b border-slate-700 pb-6 gap-4">
            ...
            <div className="flex gap-6 text-slate-400">
              ...
              <Link href="/our-school/secondary-education" className="hover:text-white">Secondary</Link>
