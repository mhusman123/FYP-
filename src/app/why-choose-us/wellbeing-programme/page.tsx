...
export default function WellbeingProgrammePage() {
  ...
  const wellbeingPillars = [
    {
      title: 'Emotional Resilience (جذباتي استقامت)',
      icon: Smile,
      badge: 'Emotional Care',
      color: 'bg-rose-50 text-rose-800 border-rose-200',
      description: 'Equipping students with self-awareness, stress management skills, and emotional agility to navigate academic pressures and adolescent transitions with confidence.'
    },
    {
      title: 'Physical Vitality & Nutrition (جسماني صحت)',
      icon: Activity,
      badge: 'Active Lifestyle',
      color: 'bg-emerald-50 text-emerald-800 border-emerald-200',
      description: 'Daily sports, balanced nutrition in campus cafeterias, ergonomic classrooms, and high-energy athletics ensuring active bodies sustain sharp minds.'
    },
    {
      title: 'Social Connectedness (سماجي ڳانڍاپو)',
      icon: Users,
      badge: 'Belonging',
      color: 'bg-blue-50 text-blue-800 border-blue-200',
      description: 'Cultivating authentic friendships, peer-mentoring circles, inclusive anti-bullying codes, and an environment where every voice is heard and respected.'
    },
    {
      title: 'Mental Clarity & Mindfulness (ذهني سڪون)',
      icon: Sun,
      badge: 'Cognitive Wellness',
      color: 'bg-amber-50 text-amber-800 border-amber-200',
      description: 'Integrating structured mindfulness pauses, digital detox days, sleep education, and reflective journaling into tutor periods across all grades.'
    }
  ]

  const faqs = [
    {
      q: 'Who forms the pastoral care team at Sindh School of Technology?',
      a: 'Our pastoral team includes Form Tutors, Head of Year Leaders, dedicated full-time Child Psychologists, certified School Counselors, and Senior Wellbeing Ambassadors overseen by Dean Muhammad Usman.'
    },
    {
      q: 'How does SST mark the annual Global Be Well Day?',
      a: 'As part of our international Cognita affiliation, the entire school pauses regular classes for a full day dedicated to physical activity, mental wellness workshops, trilingual poetry recitations, healthy cooking masterclasses, and community bonding.'
    },
    {
      q: 'What is SST’s policy on anti-bullying and student safety?',
      a: 'We operate a strict Zero-Tolerance policy against all forms of bullying (physical, verbal, or cyber). We have anonymous digital reporting channels and an active peer-support buddy system for every new admission.'
    },
    {
      q: 'How are parents involved in student wellbeing?',
      a: 'Parents receive regular pastoral updates and are invited to attend our termly Wellbeing Coffee Mornings focusing on screen time management, adolescent mental health, and exam anxiety management.'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <section className="relative overflow-hidden bg-[#002E40] text-white py-16 sm:py-24 lg:py-28">
        <HeroVideoBackground
          imageUrl="https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=85&w=2400&auto=format&fit=crop"
          posterUrl="https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=85&w=2400&auto=format&fit=crop"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.12]">
                Comprehensive Student <span className="text-cyan-300">Wellbeing Programme</span>
                <span className="block text-2xl sm:text-3xl font-semibold text-slate-300 mt-2">
                  ذهني سڪون، جسماني صحت ۽ روحاني ترقي
                </span>
              </h1>

              <p className="text-base sm:text-lg text-slate-200 leading-relaxed max-w-2xl font-normal">
                We believe academic success begins with mental, emotional, and physical wellness. Our Be Well Charter integrates mindfulness, screen-time balance, pastoral guidance, nutritional care, and physical fitness into every school day for balanced young minds.
              </p>
              ...
              <div className="grid grid-cols-4 gap-3 pt-6 border-t border-white/15">
                <div>
                  ...
                  <div className="text-[11px] text-slate-300 font-medium">Pastoral Coverage</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-cyan-300 tracking-tight">6</div>
                  <div className="text-[11px] text-slate-300 font-medium">Wellbeing Pillars</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">1:1</div>
                  <div className="text-[11px] text-slate-300 font-medium">Counselor Support</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-cyan-300 tracking-tight">30+</div>
                  <div className="text-[11px] text-slate-300 font-medium">Sports & Yoga Hours</div>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-2xl p-6 sm:p-8 bg-[#001724]/60 backdrop-blur-xl border border-cyan-500/30 shadow-2xl space-y-5">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-cyan-300">Live Student Wellbeing Stream</span>
                  </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-lg font-bold text-white tracking-tight">
                    Mindful Computing & Emotional Resilience
                  </h3>
                  <p className="text-xs text-slate-300 leading-relaxed font-light">
                    Watch our wellness workshops, outdoor mindfulness sessions, and ergonomic tech habits designed for balanced young minds in Sindh.
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-cyan-300 font-semibold">Pastoral Staff</div>
                    <div className="text-lg font-black text-white">Dedicated Full-Time</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-emerald-300 font-semibold">Student Wellness</div>
                    <div className="text-lg font-black text-white">Gold Standard</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#002E40]">
              The Four Pillars of Student Wellbeing
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              A proactive, preventative approach ensuring every student develops emotional maturity alongside scholarly excellence.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {wellbeingPillars.map((p, idx) => {
              const Icon = p.icon
              return (
                <div
                  key={idx}
                  className="bg-slate-50 rounded-3xl p-8 border border-slate-200 shadow-sm space-y-4 hover:shadow-md transition-shadow"
                >
          ...
          <div className="bg-[#002E40] text-white rounded-3xl p-8 sm:p-10 shadow-xl flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="space-y-2 text-slate-200">
              <Quote className="h-6 w-6 text-rose-300 opacity-80" />
              <p className="text-sm sm:text-base font-medium italic leading-relaxed text-white">
                "When students feel emotionally secure, valued by their teachers, and grounded in their own identity, academic excellence is a natural consequence. Wellbeing is the fertile soil in which true genius grows."
              </p>
              <div>
      ...
      <section className="bg-gradient-to-r from-[#002E40] to-[#8D1B2D] text-white py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-5">
          ...
          <p className="text-xs sm:text-sm text-slate-200 max-w-xl mx-auto">
            Speak with our pastoral and counseling leaders to learn how we protect and nurture every student at SST.
          </p>
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Button size="lg" className="bg-white text-[#002E40] hover:bg-slate-100 font-bold px-7 shadow-lg" asChild>
              <Link href="/home#enquiry-form">Connect with Counseling Team</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-slate-300 bg-white text-slate-800 hover:bg-slate-100 hover:text-slate-900 font-semibold shadow-xs" asChild>
              <Link href="/why-choose-us/digital-learning-programme">Explore Digital Learning</Link>
            </Button>
          </div>
        </div>
      </section>
