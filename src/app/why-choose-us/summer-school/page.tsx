...
export default function SummerSchoolPage() {
  ...
  const summerTracks = [
    {
      title: 'Track 1: AI, Robotics & Drone Academy',
      age: 'Ages 8 – 17',
      icon: Bot,
      badge: 'STEM & Robotics',
      color: 'bg-cyan-50 text-cyan-900 border-cyan-200',
      description: 'Hands-on programming of autonomous Arduino rovers, CAD 3D modeling, computer vision, and drone piloting mechanics with take-home maker kits.'
    },
    {
      title: 'Track 2: Trilingual Creative Writing & Theatre',
      age: 'Ages 6 – 16',
      icon: BookOpen,
      badge: 'Literary & Dramatic Arts',
      color: 'bg-amber-50 text-amber-900 border-amber-200',
      description: 'Creative short fiction, public speaking mastery, and dramatic script performance in English, Urdu, and Sindhi, culminating in a live stage showcase.'
    },
    {
      title: 'Track 3: Elite Swimming & Sports Academy',
      age: 'Ages 4 – 18',
      icon: Activity,
      badge: 'Athletics & Fitness',
      color: 'bg-emerald-50 text-emerald-900 border-emerald-200',
      description: 'Daily semi-Olympic heated pool stroke clinics, professional cricket net practice, futsal tournaments, and martial arts agility training.'
    },
    {
      title: 'Track 4: Pre-University Exam Accelerator',
      age: 'Ages 15 – 18',
      icon: GraduationCap,
      badge: 'Academic Distinction',
      color: 'bg-rose-50 text-rose-900 border-rose-200',
      description: 'Intensive masterclasses for Cambridge O/A Levels, SAT reasoning, MDCAT medical entrance, and IBA/LUMS university admissions testing.'
    }
  ]

  const faqs = [
    {
      q: 'Can non-SST students attend the Summer School?',
      a: 'Yes! Our Summer School is open to students from all private, public, and international schools across Karachi, Hyderabad, and visiting diaspora families.'
    },
    {
      q: 'What are the dates and timings for the upcoming Summer School?',
      a: 'The summer programme runs from June 15 to July 25, Monday through Thursday, from 9:00 AM to 1:30 PM. Flexible 2-week, 4-week, and full 6-week enrollments are available.'
    },
    {
      q: 'Is air-conditioned transport provided?',
      a: 'Yes, fully supervised, air-conditioned bus service is available across all major neighborhoods of Karachi (Clifton, DHA, Gulshan, PECHS, North Nazimabad) and Hyderabad (Qasimabad, Auto Bhan, Latifabad).'
    },
    {
      q: 'Do students receive a certificate at the end?',
      a: 'All students receive an official Certificate of Summer Achievement and a comprehensive portfolio of completed robotics projects, art pieces, or academic evaluations.'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <section className="relative overflow-hidden bg-[#002E40] text-white py-16 sm:py-24 lg:py-28">
        <HeroVideoBackground
          imageUrl="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=85&w=2400&auto=format&fit=crop"
          posterUrl="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?q=85&w=2400&auto=format&fit=crop"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.12]">
                SST Summer School & <span className="text-cyan-300">Maker Bootcamps</span>
                <span className="block text-2xl sm:text-3xl font-semibold text-slate-300 mt-2">
                  سمر اسڪول، ڪوڊنگ ڪيمپ ۽ سائنسي تحقيقات
                </span>
              </h1>

              <p className="text-base sm:text-lg text-slate-200 leading-relaxed max-w-2xl font-normal">
                An exhilarating summer program featuring hands-on Python and Web Development Bootcamps, AI Robotics Workshops, Intensive English/Urdu/Sindhi Creative Writing, Outdoor Sports, and Maker Space prototyping for ages 4 to 18.
              </p>
              ...
              <div className="grid grid-cols-4 gap-3 pt-6 border-t border-white/15">
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">6</div>
                  <div className="text-[11px] text-slate-300 font-medium">Weeks of Discovery</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-cyan-300 tracking-tight">20+</div>
                  <div className="text-[11px] text-slate-300 font-medium">STEM Workshops</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-white tracking-tight">4 – 18</div>
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-300 font-medium">Hands-on Projects</div>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-2xl p-6 sm:p-8 bg-[#001724]/60 backdrop-blur-xl border border-cyan-500/30 shadow-2xl space-y-5">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-cyan-300">Live Summer Camp Stream</span>
                  </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-lg font-bold text-white tracking-tight">
                    Full-Stack Coding & Science Prototyping
                  </h3>
                  <p className="text-xs text-slate-300 leading-relaxed font-light">
                    Young makers building interactive games, programming drones, and exploring art & theater in our sunny summer innovation workshops.
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-cyan-300 font-semibold">STEM Bootcamps</div>
                    <div className="text-lg font-black text-white">Python & AI</div>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-xs text-emerald-300 font-semibold">Project Output</div>
                    <div className="text-lg font-black text-white">Portfolio Showcase</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#002E40]">
              Choose Your Summer Track
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              Each track is tailored by expert educators and mentors to provide an immersive, hands-on, unforgettable summer experience.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {summerTracks.map((trk, idx) => {
              const Icon = trk.icon
              return (
                <div key={idx} className="bg-slate-50 rounded-3xl p-8 border border-slate-200 shadow-sm space-y-4 hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-[#002E40]">{trk.title}</h3>
                  <Badge className="bg-[#002E40] text-white text-[10px]">{trk.badge}</Badge>
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
                    {trk.description}
                  </p>
                </div>
          ...
          <div className="bg-[#002E40] text-white rounded-3xl p-8 sm:p-10 shadow-xl flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="space-y-2 text-slate-200">
              ...
              <p className="text-sm sm:text-base font-medium italic leading-relaxed text-white">
                "Summer is a magical time for children to discover hidden talents without the pressure of exams — whether coding a drone, mastering swimming strokes, or writing poetry in Sindhi."
              </p>
              <div>
      ...
      <section className="bg-gradient-to-r from-[#002E40] to-[#8D1B2D] text-white py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-5">
          <h2 className="text-2xl sm:text-3xl font-black">
            Reserve Your Child's Place for Summer 2026
          </h2>
          <p className="text-xs sm:text-sm text-slate-200 max-w-xl mx-auto">
            Limited seats available per cohort to ensure small group sizes and personalized attention.
          </p>
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <Button size="lg" className="bg-white text-[#002E40] hover:bg-slate-100 font-bold px-7 shadow-lg" asChild>
              <Link href="/home#enquiry-form">Register for Summer Academy</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-slate-300 bg-white text-slate-800 hover:bg-slate-100 hover:text-slate-900 font-semibold shadow-xs" asChild>
              <Link href="/why-choose-us/cognita-family">Explore Cognita Family</Link>
            </Button>
          </div>
        </div>
      </section>
